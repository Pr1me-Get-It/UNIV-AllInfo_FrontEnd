// 하나의 공지글 클릭 시 나오는 detail screen
...
export default function DetailScreen({ route, navigation }) {  // * {... , ...} : props의 구성요소를 바로 꺼낸 것! 
                                                                // route : '이 화면으로 올 때 넘어온 정보'가 들어있는 객체
                                                                // navigation : 다른 화면으로 이동할 수 있는 함수들이 들어있는 객체
